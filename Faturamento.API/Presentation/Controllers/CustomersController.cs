...
namespace Faturamento.API.Presentation.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CustomersController : ControllerBase
    {
        private readonly FaturamentoAPIContext _context;

        public CustomersController(FaturamentoAPIContext context)
        {
            _context = context;
        }
